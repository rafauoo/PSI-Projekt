...
def start_udp_server(udp_socket, shared_dict, destination_server, destination_port, 
    ...
    while True:
        ...
        try:
            ...
            close_tcp_connection(udp_socket, shared_dict, id, tunnel_client_ip, tunnel_client_port)
...
def main():
    ...
    udp_thread = threading.Thread(target=start_udp_server, args=(udp_socket, shared_dict, args.destination_server, 
                                                                 args.destination_port, args.tunnel_client_ip, 
